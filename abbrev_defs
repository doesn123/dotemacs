...
(define-abbrev-table 'global-abbrev-table
  '(
    ("background" "prefix
" nil :count 13)
    ("bg" "background" nil :count 3)
    ("faq" "frequently asked questions" nil :count 1)
    ("gh" "George Hadow" nil :count 7)
    ("kb" "keybindings" nil :count 1)
   ))
...
(define-abbrev-table 'xah-elisp-mode-abbrev-table
  '(
    ...
    ("alist-get" "(alist-get key▮ value &optional default)" xah-elisp--ahf :count 2)
    ("and" "(and ▮)" xah-elisp--ahf :count 0)
    ("append" "(append ▮)" xah-elisp--ahf :count 2)
    ("append-to-file" "(append-to-file p1▮ p2 FILENAME)" xah-elisp--ahf :count 0)
    ("apply" "(apply ▮)" xah-elisp--ahf :count 2)
    ...
    ("assq" "(assq key▮ alist)" xah-elisp--ahf :count 2)
    ...
    ("cb" "current-buffer" xah-elisp--ahf :count 1)
...
(CONDITION BODY)
    ...
    ("cons" "(cons CAR▮ CDR)" xah-elisp--ahf :count 5)
    ...
    ("d" "defun" xah-elisp--ahf :count 10)
...
3
    ...
    ("div" "(/ ▮ y)" xah-elisp--ahf :count 0)
    ("dk" "define-key" xah-elisp--ahf :count 0)
    ("dolist" "(dolist (x LIST▮ [RESULT]) BODY)" xah-elisp--ahf :count 1)
    ...
    ("elt" "(elt SEQUENCE▮ N)" xah-elisp--ahf :count 1)
    ...
    ("expand-file-name" "(expand-file-name ▮ &optional relativedir)" xah-elisp--ahf :count 1)
    ("expt" "(expt ▮ y)" xah-elisp--ahf :count 0)
    ("f" "format" xah-elisp--ahf :count 0)
    ("fboundp" "(fboundp '▮)" xah-elisp--ahf :count 0)
    ("fc" "forward-char" xah-elisp--ahf :count 1)
    ...
    ("funcall" "(funcall 'FUNCTION▮ &rest ARGUMENTS)" xah-elisp--ahf :count 9)
    ...
    ("get" "(get SYMBOL▮ 'PROPNAME)" xah-elisp--ahf :count 1)
  ...
  (progn )
    ...
    ("interactive" "(interactive)" xah-elisp--ahf :count 4)
    ...
    ("lambda" "(lambda (x▮) BODY)" xah-elisp--ahf :count 3)
 ...
 x
    ...
    ("list" "(list ▮)" xah-elisp--ahf :count 1)
    ...
    ("m" "message" xah-elisp--ahf :count 11)
    ...
    ("make-marker" "(make-marker)" xah-elisp--ahf :count 0)
...
(lambda (x▮) BODY)
 ...
 (narrow-to-region p1▮ p2) 
    ...
    ("point-marker" "(point-marker)" xah-elisp--ahf :count 0)
...
▮)" xah-elisp--ahf :count 0)
    ...
    ("rassq" "(rassq value▮ alist)" xah-elisp--ahf :count 1)
 ...
 (narrow-to-region p1▮ p2) 
    ...
    ("sc" "shell-command" xah-elisp--ahf :count 1)
    ...
    ("set-marker" "(set-marker MARKER▮ POSITION &optional BUFFER)" xah-elisp--ahf :count 0)
    ...
    ("setq" "(setq ▮)" xah-elisp--ahf :count 10)
    ("setq-default" "(setq-default x▮ VAL)" xah-elisp--ahf :count 1)
    ...
    ("split-string" "(split-string ▮ &optional SEPARATORS OMIT-NULLS)" xah-elisp--ahf :count 2)
    ("sqa" "shell-quote-argument" xah-elisp--ahf :count 0)
    ("sr" "save-restriction" xah-elisp--ahf :count 0)
    ("ss" "split-string" xah-elisp--ahf :count 2)
...
(replace-match NEWTEXT &optional FIXEDCASE LITERAL STRING SUBEXP))" xah-elisp--ahf :count 1)

...
(define-abbrev-table 'xah-elisp-mode-abbrev-table
  '(
    ...
    ("c" "concat" xah-elisp--ahf :count 1)
...
3
    ...
    ("f" "format" xah-elisp--ahf :count 3)
    ...
    ("ff" "find-file" xah-elisp--ahf :count 1)
    ...
    ("format" "(format \"%s\" ▮)" xah-elisp--ahf :count 1)
    ...
    ("global-set-key" "(global-set-key (kbd \"C-▮\") 'COMMAND)" xah-elisp--ahf :count 2)
    ("gnb" "generate-new-buffer" xah-elisp--ahf :count 0)
    ("goto-char" "(goto-char ▮)" xah-elisp--ahf :count 0)
    ("gsk" "global-set-key" xah-elisp--ahf :count 2)
...
▮)" xah-elisp--ahf :count 0)
 ...
 (narrow-to-region p1▮ p2) 
    ...
    ("setq" "(setq ▮)" xah-elisp--ahf :count 2)
